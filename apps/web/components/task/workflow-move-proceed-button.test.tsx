...
describe("WorkflowMoveProceedButton", () => {
  ...
  it("opens the options form from the direct desktop action", () => {
    renderProceed();
    openHoveredForm();
  ...
  it("anchors the options form to the same direct action", () => {
    renderProceed();
    openHoveredForm();

    expect(screen.getByTestId(OPTIONS_TEST_ID)).toBeTruthy();
    expect(screen.getByTestId(PROCEED_TEST_ID)).toBeTruthy();
  });
